...
int main(int argc, char** argv)
{
	...
	std::vector<sdds::Workstation*> theStations;
	std::vector<sdds::CustomerOrder> theOrders;
	...
	try {
		...
		::loadFromFile<sdds::CustomerOrder>(argv[3], theOrders);
		...
		for (auto& order : theOrders) {
			...
			sdds::g_pending.push_back(std::move(order));
		}
		std::cout << std::endl << std::endl;
		...
		std::cout << "========================================" << std::endl;
		sdds::LineManager lm(argv[4], theStations);
		lm.display(std::cout);
		std::cout << std::endl << std::endl;
	...
	std::cout << "========================================" << std::endl;
	for (const auto& o : sdds::g_completed)
		o.display(std::cout);
	std::cout << std::endl << std::endl;
	...
	std::cout << "========================================" << std::endl;
	for (const auto& o : sdds::g_incomplete)
		o.display(std::cout);
	std::cout << std::endl << std::endl;
	...
	std::cout << "========================================" << std::endl;
	for (const sdds::Station* theItem : theStations)
